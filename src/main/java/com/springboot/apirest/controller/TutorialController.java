...
import com.springboot.apirest.repository.TutorialRepository;
...
public class TutorialController {
	...
	public ResponseEntity<Dummy> getYo(@RequestParam(required = false) String title) {
		...
		postman, para ver con un instanceOf como los evalua, y sobretodo si van campos a null, como sabe diferenciarlos
